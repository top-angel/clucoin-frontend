...
export default function Terms() {
  return (
    <>
      <Head>
        <title>CluCoin - Terms of Service</title>
      </Head>
      <div className="Container">
        <div className="TermsBox">
          ...
          <h2 className="text-pink">Interpretation and Definitions</h2>
          <h3 className="text-pink">Interpretation</h3>
          <p>
          ...
          <h2 className="text-pink">Definitions</h2>
          <p>For the purposes of these Terms and Conditions:</p>
          <p>
            <span className="font-weight-bold">Affiliate</span> means an entity
          ...
          <p>
            <span className="font-weight-bold">Country</span> refers to: Utah,
            United States.
          </p>
          <p>
            <span className="font-weight-bold">Company</span> (referred to as
            either &#34;the Company&#34;, &#34;We&#34;, &#34;Us&#34; or
            &#34;Our&#34; in this Agreement) refers to CluCoin Inc.
          </p>
          <p>
            <span className="font-weight-bold">Device</span> means any device
            that can access the Service such as a computer, a cellphone or a
            digital tablet.
          </p>
          <p>
            <span className="font-weight-bold">Service</span> refers to the
            Website.
          </p>
          <p>
            <span className="font-weight-bold">Terms and Conditions</span> (also
          ...
          <p>
            <span className="font-weight-bold">Website</span> refers to CluCoin,
            accessible from https://clucoin.com
          </p>
          <p>
            <span className="font-weight-bold">You</span> means the individual
          ...
          <h2 className="text-pink">Acknowledgment</h2>
          <p>
          ...
          <h2 className="text-pink">Links to Other Websites</h2>
          <p>
          ...
          <h2 className="text-pink">Termination</h2>
          <p>
          ...
          <h2 className="text-pink">Limitation of Liability</h2>
          <p>
          ...
          <h2 className="text-pink">Governing Law</h2>
          <p>
          ...
          <h2 className="text-pink">Disputes Resolution</h2>
          <p>
            If You have any concern or dispute about the Service, You agree to
            first try to resolve the dispute informally by contacting the
            Company.
          </p>
          <h2 className="text-pink">For European Union (EU) Users</h2>
          <p>
            If You are a European Union consumer, you will benefit from any
            mandatory provisions of the law of the country in which you are
            resident in.
          </p>
          <h2 className="text-pink">United States Legal Compliance</h2>
          <p>
          ...
          <h2 className="text-pink">Severability and Waiver</h2>
          <h3 className="text-pink">Severability</h3>
          <p>
          ...
          <h2 className="text-pink">Waiver</h2>
          <p>
          ...
          <h2 className="text-pink">Translation Interpretation</h2>
          <p>
            These Terms and Conditions may have been translated if We have made
            them available to You on our Service. You agree that the original
            English text shall prevail in the case of a dispute.
          </p>
          <h2 className="text-pink">Changes to These Terms and Conditions</h2>
          <p>
          ...
          <h2 className="text-pink">Contact Us</h2>
          <ul className="list-unstyled">
            ...
            <ul>
              <li>
                <span className="font-weight-bold">By email:</span>{" "}
                contact@clucoin.com
              </li>
            </ul>
          </ul>
